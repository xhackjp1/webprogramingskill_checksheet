...
webアプリケーションを知識ゼロから作成する上で抑えておいて欲しい項目を列挙した  
全ての項目にチェックすることができたのなら、シンプルなウェブアプリケーションを作成する基礎知識が身についていることを保障しよう

ここはスタートラインに過ぎないが、どんな海に漕ぎ出したとしても今の知識の応用で乗り切ることができるはずだ
...
チェックは上からやる必要はない、まずはざっと見渡して知っている箇所にとりあえずチェックをしていこう  
一つもチェックできないなんてことはないはずだ、まずは全体のうちどのくらいの位置にいるかを知ろう  

次に、知らない用語がないかチェックしてみよう  
検索してヒットした記事を読みさえすればチェックできる項目も多いはずだ  
